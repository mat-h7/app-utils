...
const encrpytor = require("../src/encryptor.js");
...
const cipher = encrpytor.encrypt(fileBuffer);
...
const plain = encrpytor.decrypt(cipher);
...
const plain2 = encrpytor.decrypt(cipher2);
